...
# -------------------------------------------------------------------------------------------------------------
 ...
 # ---> 1. En la consola del navegador, crea un pequeño programa que le pida al usuario que ingrese un nùmero, multiplica ese número por 2 y muestra en salida el resultado de esa operación. <---
...
# ---> 3 Escribe un programa que calcule el área de un círculo con un radio r = 53 Imprime el área en pantalla (Fórmula: pi*r*r) <---

# ---> 4. Escribe un programa que calcule el área de un rombo, sabiendo que D = 8cm, d= 6cm (Formula: a=DXd/2) <---
...
# ---> 3. Crea el mismo problema 2, ahora usando Do While <---
